        ...
        <div className="container my-5 py-2">
          <div className="row">
            <div className="col-md-6 col-sm-12 py-3">
              <img src={product.image} alt={product.title} className='img-fluid' width="400px" height="400px"/>
            </div>
            <div className="col-md-6 col-md-6 py-5">
              <h4 className="text-uppercase text-muted">{product.category}</h4>
              <h1 className='display-5'>{product.title}</h1>
              <p className='lead'>{product.rating && product.rating.rate}{" "} <Grade/> </p>
              ...
              {similarProducts.map((item) => {
                return (
                  <div className="card mx-4 text-center" key={item.id}>
                    <img src={item.image} alt="Card" height={300} width={300} className='card-img-top p-3'/>
                    <div className="card-body">
                      <h5 className='card-title'>{item.title.substring(0, 15)}...</h5>
                    </div>
                    <div className="card-body">
                      <Link to={"/product/"+ item.id} className="btn btn-dark m-1">Buy Now</Link>
